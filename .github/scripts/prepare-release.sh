...
curl --fail --location --silent --show-error --retry 3 -H "Authorization: Bearer $GH_TOKEN" -H "Accept: application/vnd.github.raw+json" "https://api.github.com/repos/TF-Minecraft/ServerAssets/contents/jars/a5f593d6214b/item-nbt-api-plugin-2.15.0.jar?ref=$ref" > "libs/item-nbt-api-plugin-2.15.0.jar"
